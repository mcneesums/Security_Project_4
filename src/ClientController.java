...
public class ClientController {
	 ...
	 */
	public boolean initGroupClient(String server, int port, ClientController cc) {
	...
	public boolean getToken (String username, String password) {
		token = (Token)gClient.getToken(username, password);
	 ...
	 * @return True if the values were valid and the instance was created, false if not.
	 */
	public boolean initFileClient(String server, int port, ClientController cc) {
		boolean clientInit = false;
